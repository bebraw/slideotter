...
const elements: Record<string, any> = {
  ...
  contentRunRail: optionalElement("content-run-rail"),
  ...
  layoutStudioOpenSlideButton: requiredElement("layout-studio-open-slide-button"),
  layoutStudioPage: requiredElement("layout-studio-page"),
  ...
  showLayoutStudioPageButton: requiredElement("show-layout-studio-page"),
