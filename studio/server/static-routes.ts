...
function handlePreviewStaticRoute(req: ServerRequest, res: ServerResponse, url: URL): boolean {
...
function handleMaterialStaticRoute(res: ServerResponse, url: URL): boolean {
...
export function handleStatic(req: ServerRequest, res: ServerResponse, url: URL): void {
  if (handlePreviewStaticRoute(req, res, url) || handleMaterialStaticRoute(res, url)) {
    return;
  }
