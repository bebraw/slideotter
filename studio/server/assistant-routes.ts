...
export function createAssistantApiRoutes(handlers: AssistantRouteHandlers): readonly ApiRoute[] {
  return [
    { method: "GET", pathname: "/api/v1/assistant/session", handler: handlers.handleAssistantSession },
    { method: "POST", pathname: "/api/v1/assistant/message", handler: handlers.handleAssistantSend }
  ];
}
