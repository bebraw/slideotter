...
export function renderPresentationDocument(payload: unknown): string {
  ...
  return [
    ...
    "      </section>",
    "      <aside class=\"dom-presentation-narration\" aria-label=\"Narration controls\">",
    "        <div class=\"dom-presentation-narration__header\">",
    "          <strong>Narration</strong>",
    "          <button type=\"button\" data-narration-action=\"toggle\" aria-expanded=\"true\">Minimize</button>",
    "        </div>",
    "        <div class=\"dom-presentation-narration__body\" data-narration-body>",
    "          <div class=\"dom-presentation-narration__controls\">",
    "            <button type=\"button\" data-narration-action=\"play\">Narrate</button>",
    ...
    "            <p data-narration-script>No narration script for this slide.</p>",
    "          </details>",
    "        </div>",
    "      </aside>",
    "    </main>",
