...
- The included `slideotter` project presentation is a twenty-slide deck covering the problem, storage model, editor loop, materials, generation, planning, validation, archive, maintenance, and roadmap.
