...
- Spec and Chat drawer tabs use narrower closed rails on desktop and short bottom handles on mobile, and the mobile slide selector hides file names to keep the active slide and current action dominant.
