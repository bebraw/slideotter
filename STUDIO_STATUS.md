...
- New presentation setup captures a target slide count alongside audience, tone, objective, constraints, and theme brief; the saved target feeds the Deck Planning length scaler.
