...
- Use the rich slide-family ADR when adding first-class dividers, quote slides, photo slides, split-photo layouts, or generation that changes slide family.
