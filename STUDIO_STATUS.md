...
- Generation diagnostics live in a left-side Debug drawer and group prompt budgets, source retrieval, and recent workflow events behind one inspectable panel.
