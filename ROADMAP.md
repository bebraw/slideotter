...
- [`docs/adr/proposed/0051-demo-hypermedia-affordance-explorer.md`](./docs/adr/proposed/0051-demo-hypermedia-affordance-explorer.md) for making resource links and action descriptors visible enough to demo hypermedia affordances
- [`docs/adr/proposed/0052-agent-action-timeline-and-demo-replay.md`](./docs/adr/proposed/0052-agent-action-timeline-and-demo-replay.md) for showing agent workflow steps and enabling deterministic stage demos
- [`docs/adr/proposed/0053-demo-candidate-review-loop.md`](./docs/adr/proposed/0053-demo-candidate-review-loop.md) for a focused before/after/apply/validate loop around agentic slide improvement
