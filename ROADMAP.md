...
7. Extend SVGL logo search from ADR 0054 only when real decks need refinements beyond the implemented bounded workflow: explicit user selection, presentation-local imports, provenance metadata, SVG sanitization, and normal media validation before slide use.
