...
- [`docs/adr/proposed/0040-variant-review-and-slide-editing-workbench-modularization.md`](./docs/adr/proposed/0040-variant-review-and-slide-editing-workbench-modularization.md) for the next browser-client split around variant review, comparison, and current-slide editing
...
7. Continue browser-client modularization from ADR 0040 by extracting variant review/comparison before current-slide editing.
