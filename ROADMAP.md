...
- [`docs/adr/proposed/0046-cloud-llm-provider-boundary.md`](./docs/adr/proposed/0046-cloud-llm-provider-boundary.md) for keeping hosted LLM generation behind workspace/provider policy instead of calling local LM Studio directly
- [`docs/adr/proposed/0047-merge-deck-planning-into-slide-studio.md`](./docs/adr/proposed/0047-merge-deck-planning-into-slide-studio.md) for moving deck-level planning controls into the main Slide Studio workspace without losing explicit proposal review
