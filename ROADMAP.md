...
- [`docs/adr/proposed/0058-local-llm-narration-refinement.md`](./docs/adr/proposed/0058-local-llm-narration-refinement.md) for proposed local LLM rewriting of reviewable narration scripts without changing visible slide copy
