...
- [`docs/adr/proposed/0062-dedicated-memory-workbench.md`](./docs/adr/proposed/0062-dedicated-memory-workbench.md) for a dedicated Memory view that visualizes and manipulates typed memory resources, evidence, dependencies, and derived slidesets
