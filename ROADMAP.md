...
- [`docs/adr/proposed/0064-reviewed-latex-and-pdf-paper-import.md`](./docs/adr/proposed/0064-reviewed-latex-and-pdf-paper-import.md) for reviewed, fingerprint-bound LaTeX/PDF paper intake that reuses a bounded Kirjolab-derived core without importing its application runtime
