...
- [`docs/adr/implemented/0040-variant-review-and-slide-editing-workbench-modularization.md`](./docs/adr/implemented/0040-variant-review-and-slide-editing-workbench-modularization.md) for the implemented variant review workbench split and the follow-up current-slide editing boundary
- [`docs/adr/proposed/0041-current-slide-and-deck-planning-workbench-modularization.md`](./docs/adr/proposed/0041-current-slide-and-deck-planning-workbench-modularization.md) for the next browser-client split around current-slide editing, deck planning, and source-library behavior
...
7. Continue browser-client modularization from ADR 0041 by extracting current-slide editing first, then deck planning and source-library behavior.
