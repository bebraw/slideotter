...
10. Continue Cloudflare hosting from ADR 0019 by adding real D1/R2-backed adapters, authenticated workspace resources, and a hosted rendering proof after the current Workers Static Assets shell and storage-contract baseline.
