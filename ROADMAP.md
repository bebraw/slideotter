...
5. Continue live current-slide validation and direct mechanical repair controls from ADR 0034. The custom-layout preview now surfaces current-slide DOM validation, gates favorite-ready custom layouts, and offers compact-spacing repair drafts; the next slice is direct repairs for clipped text, cropping, and progress-area issues.
