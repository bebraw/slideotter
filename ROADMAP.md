...
2. Continue ADR 0005 beyond the now-implemented divider, quote, photo, deck-local layout library, and favorite-layout reuse foundation: add generated layout workflows and richer slide families so common requests such as split-photo slides map to validated structured specs and shareable JSON layout definitions.
