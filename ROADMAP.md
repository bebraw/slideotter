...
- [`docs/adr/proposed/0046-cloud-llm-provider-boundary.md`](./docs/adr/proposed/0046-cloud-llm-provider-boundary.md) for starting hosted generation with Workers AI behind workspace/provider policy instead of calling local LM Studio directly
