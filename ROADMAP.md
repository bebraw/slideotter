...
10. Continue Cloudflare hosting from ADR 0019 by adding authenticated workspace writes, import/export bundles, queue-backed jobs, and a hosted rendering proof after the current Workers Static Assets shell, D1/R2 adapter, read endpoint, and schema baseline.
