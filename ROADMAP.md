...
- [`docs/adr/proposed/0031-slide-studio-live-presentation-creation.md`](./docs/adr/proposed/0031-slide-studio-live-presentation-creation.md) for replacing the separate post-outline Content phase with live progressive generation inside Slide Studio
...
2. Continue staged creation hardening from ADR 0031 by replacing the separate post-outline Content phase with live progressive slide generation inside Slide Studio.
