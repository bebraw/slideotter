...
2. Continue ADR 0005 beyond the now-implemented divider family: add richer slide families and a reusable layout library so common requests such as quote, photo, and split-photo slides map to validated structured specs and shareable JSON layout definitions.
